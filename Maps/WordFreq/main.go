...
func main() {
	...
	s := []string{"in", "my", "younger", "and", "more", "vulnerable", "years", "my", "father", "gave",
		...
		"had.", "he", "didn’t", "say", "any", "more,", "but", "we’ve", "always", "been", "unusually", "some",
		...
		"natures", "to", "me", "and", "also", "made", "me", "the", "victim", "of", "not", "a", "few", "me",
		...
		"infinite", "hope.", "i", "am", "still", "a", "little", "afraid", "of", "missing", "something",
		"forget", "that,", "as", "my", "father", "snobbishly", "suggested,", "and", "i", "snobbishly",
		"repeat,", "a", "sense", "of", "the", "fundamental", "decencies", "is", "parcelled", "out", "if", "i",
		...
		"only", "gatsby,", "the", "man", "who", "gives", "his", "name", "to", "this", "book,", "was", "out",
		...
		"successful", "gestures,", "then", "there", "was", "something", "gorgeous", "about", "him,", "dust",
		...
		"which", "it", "is", "not", "likely", "i", "shall", "ever", "find", "again.", "no—gatsby", "turned",
		"all", "right", "at", "the", "end;", "it", "is", "what", "preyed", "on", "gatsby,", "what", "foul",
		...
		"just", "a", "quarter", "of", "a", "century", "after", "my", "father,", "and", "a", "little", "later",
		"participated", "in", "that", "delayed", "teutonic", "migration", "known", "as", "the", "great", "i",
		"war.", "i", "enjoyed", "the", "counter-raid", "so", "thoroughly", "that", "i", "came", "back",
		"restless.", "instead", "of", "being", "the", "warm", "centre", "of", "the", "world,", "the",
		"west", "now", "seemed", "like", "the", "ragged", "edge", "of", "the", "universe—so", "i", "middle",
		...
		"woman,", "who", "made", "my", "bed", "and", "cooked", "breakfast", "and", "muttered", "breath-giving",
		"finnish", "wisdom", "to", "herself", "over", "the", "electric", "stove.", "it", "was", "lonely",
		...
		"settler.", "he", "had", "casually", "conferred", "on", "me", "the", "freedom", "of", "the", "with",
		"neighbourhood.", "and", "so", "with", "the", "sunshine", "and", "the", "great", "bursts", "of",
		"leaves", "growing", "on", "the", "trees,", "just", "as", "things", "grow", "in", "fast", "movies,",
		...
		"much", "fine", "health", "to", "be", "pulled", "down", "out", "of", "the", "young", "for",
		"air.", "i", "bought", "a", "dozen", "volumes", "on", "banking", "and", "credit", "and", "for", "a",
